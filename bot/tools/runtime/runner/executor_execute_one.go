...
// elsewhere.
func (e *Executor) promptConfirm(tc core.ToolCallItem, tool core.Tool, confirmFn protocol.ConfirmFunc, predictedReq *core.PermissionRequest, dec permissionDecision) (protocol.ConfirmReply, bool) {
	if confirmFn == nil {
