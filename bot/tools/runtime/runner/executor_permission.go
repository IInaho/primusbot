...
func (e *Executor) tryPermissionEscalation(ctx context.Context, tool core.Tool, tc core.ToolCallItem, execErr error, confirmFn protocol.ConfirmFunc, preApproved escalationApproval, hasPreApproval bool) (output string, ok bool, reason escalationFailReason, causeErr error) {
