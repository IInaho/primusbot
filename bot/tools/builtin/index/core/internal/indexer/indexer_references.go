...
func (i *Indexer) ResolveReferences(g *graphpkg.Graph) {
	resolveReferences(g)
}

func resolveReferences(g *graphpkg.Graph) {
	nameIndex := make(map[string][]*graphpkg.Node)
