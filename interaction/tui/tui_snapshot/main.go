...
// Run: go run ./interaction/tui/tui_snapshot
package main
...
import (
	...
	components "nekocode/interaction/tui/components"
...
func renderToolBlocks() string {
	return block.RenderTools([]block.ContentBlock{
		...
		},
		{
			Type:     block.BlockTool,
			ToolName: "shell",
			ToolArgs: "git status --short interaction/tui/components/block/block_render.go interaction/tui/components/block/block_tool.go interaction/tui/components/block/block_tool_test.go interaction/tui/styles/colors.go interaction/tui/components/processing/processing_test.go",
			Content:  " M interaction/tui/components/block/block_render.go\n M interaction/tui/components/block/block_tool.go\n M interaction/tui/components/block/block_tool_test.go\n M interaction/tui/components/processing/processing_test.go\n M interaction/tui/styles/colors.go",
			Done:     true,
		},
		{
			Type:     block.BlockTool,
